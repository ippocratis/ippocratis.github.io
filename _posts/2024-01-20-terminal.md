...
This post aims to host maintain a growing list of bash scripts that can be run on the andorid terminal to perform tasks not available through the User Interface or an application.
