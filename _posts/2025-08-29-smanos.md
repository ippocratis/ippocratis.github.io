...
CVE-2019-13361/poc.py at 75712ea4d6308d2c2d5bc3693b27170da6869cc9 · lodi-g/CVE-2019-13361
...
CGWPCS48 set WiFi code
05 action code? In this case setup?
20250824165905 timestamp 24 aug 2025 16:59 and 05 sec


set_wifi: receiving:    b'CGWPSC03030123456A*
*\r'

Acknowledge message with device id 1234567A
...
CGWPCS53  Set mode class

0000 action code?

Disarm command **0

disarm: receiving:      b'CGWPSC5300001234567A*
...
Trggering a sensor will the panel mode armed or home will print 
...
A one minute interval CGWPSC03030DEVICE_ID** code is broadcasted from the panel while it’s armed.
